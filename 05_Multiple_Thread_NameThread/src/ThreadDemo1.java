//We can set Thread Name what I want
public class ThreadDemo1 {
	...
	public static void main(String[] args) throws Exception  // we use throws Exception to handle join 
	{
		...
		System.out.println(t1.getName()); // default name will give-Hi Thread
		System.out.println(t2.getName()); // default name will give-Hello Thread
